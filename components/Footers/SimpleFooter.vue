<template>
	<section id="footer1" class="bg-gray-900 p-20 mt-32 flex justify-between gap-20">
		...
		<section class="grow basis-1/3">
			...
			<p class="text-gray-600 mt-4">Este proyecto es simplemente una práctica para aprender como funsiona <strong
					class="text-gray-500 font-bold">NUXT.js</strong> y ver como mejora la experiencia de desarrollo en <strong
					class="text-gray-500 font-bold">Vue.js</strong>
			</p>
		</section>
		<section class="grow basis-1/3">
			...
			<div class="mt-4">
				<a href="https://github.com/HarmonySpace">
					<svg class="fill-gray-500 w-12 duration-75 ease-out hover:scale-125 hover:fill-blue-500"
