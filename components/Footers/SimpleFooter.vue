<template>
	<section id="footer1" class="bg-blue-900 p-20 mt-32 flex justify-between gap-20">
		...
		<section class="grow basis-1/3">
			...
			<p class="text-blue-600 mt-4">Este proyecto es simplemente una práctica para aprender como funsiona <strong
					class="text-blue-500 font-bold">NUXT.js</strong> y ver como mejora la experiencia de desarrollo en <strong
					class="text-blue-500 font-bold">Vue.js</strong>
			</p>
		</section>
		<section class="grow basis-1/3">
