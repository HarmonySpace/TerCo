...
<template>
  <section class="pt-32 flex flex-wrap justify-between w-full">
    <div class="flex flex-wrap justify-center items-center gap-2 w-full h-full md:flex-nowrap">
      ...
      <InputsSimpleInput class="grow basis-full md:basis-auto" @getValue="(value) => updateFile(value)"
        :placeholder="store.getFile()" :value="file" />
      <ButtonsIconButton class="grow basis-full w-icon-1 my-8 md:basis-1/12 md:my-0"
        icon="heroicons:arrow-path-16-solid" @click="resetColors()" />
    </div>
